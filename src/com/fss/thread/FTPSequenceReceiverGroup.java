...
public class FTPSequenceReceiverGroup extends FTPSequenceReceiver
{
	////////////////////////////////////////////////////////
	// Member variables
	////////////////////////////////////////////////////////
	...
	{
		// Fill parameter of ftp receiver
		...
		// Fill parameter of ftp sequence receiver
	...
	public void fillParameter(Vector vtParameterValue) throws Exception
	{
		...
		mstrBackupDir = loadDirectory("BackupDir",(String)vtParameterValue.elementAt(8),false,false);
