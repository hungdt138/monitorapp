...
public interface Encoding
{
	...
	char addBreveHorn(char c);
	char addCircumflex(char c);
	char addStroke(char c);
	String fromUnicode(String str);
	String getDescription();
	String getID();
	boolean hasDiacritic(char c);
	boolean isVowel(char c);
	char modifyTone(char original, int toneMark);
