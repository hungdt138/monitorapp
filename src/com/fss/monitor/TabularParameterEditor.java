...
class TabularParameterEditor extends JButton implements ControlableValue
{
	...
	public TabularParameterEditor(Component cmp,boolean bModal,
	...
	private void onClick()
	{
		try
		{
			DialogTabularParameter dlg = new DialogTabularParameter(cmpCaller,mbModal,mstrTitle,mvtDefinition,mvtValue);
